...
The project structure is updated with the font icon and scss partial:</p>
<pre rel="Folder structure">
<code class="dts">
FOO-project/
static/
...
I hope this article is meaningful to you and if you have any questions or remarks you can find me on twitter @mirelvt or you can email me <a href="mailto:mailenm@mirellavanteulingen.nl">mailenm@mirellavanteulingen.nl</a>.
